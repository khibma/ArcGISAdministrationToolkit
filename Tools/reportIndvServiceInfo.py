'''
This script will returned detailed information about a service
...
def getServiceInfo(server, port, adminUser, adminPass, service, token=None):
    ''' Function to get and display a detailed information about a particular service
...
if __name__ == "__main__":     
    ...
    getServiceInfo(server, port, adminUser, adminPass, service)